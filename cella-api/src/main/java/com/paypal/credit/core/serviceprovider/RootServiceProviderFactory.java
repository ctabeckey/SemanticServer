 ...
 *
 */
public class RootServiceProviderFactory
    implements ServiceProviderFactory
{
    ...
    private final ServiceLoader<ServiceProviderFactory> serviceLoader;
    ...
    private static final Map<ClassLoader, RootServiceProviderFactory> rootServiceProviderFactoryCache =
     ...
     * @return
     */
    public static RootServiceProviderFactory getOrCreate() {
     ...
     * @return
     */
    public static RootServiceProviderFactory getOrCreate(ClassLoader classLoader) {
        RootServiceProviderFactory serviceFactory = null;
        ...
        if (serviceFactory == null) {
            ...
            serviceFactory = new RootServiceProviderFactory(classLoader);
    ...
    /**  */
    private final static String PUBLISHER = RootServiceProviderFactory.class.getName();
    ...
    public final Set<DataSourceDescription<?>> getInstalledProviders() {
        synchronized (this.dataSourceDescriptions) {
            if (this.dataSourceDescriptions.isEmpty()) {
                for (ServiceProviderFactory providerFactory : this.serviceLoader) {
     ...
     */
    private RootServiceProviderFactory(ClassLoader cl) {
        this.serviceLoader = ServiceLoader.load(ServiceProviderFactory.class, cl);
    }
	 ...
	 * @param dataSourceApi
     * @param routingToken
	 * @param serviceProviderExceptionHandlers
	 * @param <S>
	 * @return
	 */
	public final <S extends ServiceProviderInterface> S createDataSource(
			Class<S> dataSourceApi,
            RoutingToken routingToken,
			ServiceProviderExceptionHandler... serviceProviderExceptionHandlers)
    ...
    // ===============================================================================================
    private final Map<Class<?>, ServiceProviderInterface> serviceInstanceCache = new ConcurrentHashMap<>();
    private <S extends ServiceProviderInterface> S getOrCreateService(final DataSourceDescription<S> dsd)
    ...
    public final DataSourceDescription findDataSource(
            Class<? extends ServiceProviderInterface> dataSourceApi,
            RoutingToken routingToken) {
        for (DataSourceDescription dsd : getInstalledProviders()) {
     ...
     */
    public final static class DataSourceDescription<S extends ServiceProviderInterface>
