...
public class FacadeRouterUtility
{
	 ...
	 *
	 */
	private static Map<Class<?>, ? extends ProcessorBridge> routers =
		new java.util.HashMap<Class<?>, ProcessorBridge>();
	 ...
	 */
	public static <R extends ProcessorBridge> R getFacadeRouter(Class<R> interfaceClass)
	throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		...
		{
			ProcessorBridge cachedRouter = routers.get(interfaceClass);
