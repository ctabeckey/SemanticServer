...
public class ProcessorProviderException extends Exception {
     ...
     */
    public ProcessorProviderException() {
    }
     ...
     * @since 1.7
     */
    public ProcessorProviderException(final String message, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace) {
