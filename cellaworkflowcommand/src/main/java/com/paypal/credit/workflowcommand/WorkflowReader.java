...
public class WorkflowReader {
    ...
    private static Unmarshaller createUnmarshaller() throws JAXBException {
        JAXBContext jc = JAXBContext.newInstance("com.paypal.credit.workflowcommand.workflow.schema");
    ...
    public static WorkflowType create(final InputStream inStream)
        ...
        JAXBElement<WorkflowType> unmarshalled = (JAXBElement) unmarshaller.unmarshal(inStream);
    ...
    public static WorkflowType create(final File workflowFile)
        ...
        JAXBElement<WorkflowType> unmarshalled = (JAXBElement) unmarshaller.unmarshal(workflowFile);
        return unmarshalled.getValue();
    }
